...
- groups:
  - system:masters
  userarn: arn:aws:iam::${get_aws_account_id()}:user/root
- groups:
  - system:masters
  userarn: arn:aws:iam::${get_aws_account_id()}:user/terraform
- groups:
  - system:masters
  userarn: arn:aws:iam::${get_aws_account_id()}:user/allan
EOT
}